          ...
          <div className="w-full max-w-md space-y-8">
            <div className="text-center lg:text-left">
              ...
              <p className="mt-2 text-gray-600">
                Join our community and start your home improvement journey
              </p>
            </div>
                    ...
                    <div className="mt-2">
                      <div className="flex items-center space-x-1">
                        {[1, 2, 3, 4, 5].map((level) => (
                          <div
                            key={level}
                            className={`h-2 w-8 rounded ${level <= passwordStrength ? (passwordStrength <= 2 ? 'bg-red-400' : passwordStrength <= 3 ? 'bg-yellow-400' : 'bg-green-400') : 'bg-gray-200'}`}
                          />
                        ))}
                      </div>
